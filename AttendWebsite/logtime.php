...
<head> 
    ...
    <link rel="stylesheet" type="text/css" href="FrontPageStyle/frontPageStyleSheet(Tamikal).css" />
...
<div class="banner"> </div>
      ...
      <form action="logtime.php" method= "POST">
        ...
        <div class="contents" >
            ...
            <p style="color:white">Enter last six digits of your 870 number: </p>
           ...
           <!-- <p style="display:inline">Enter Date(y:m:d): </p>
            ...
            <p style="color:white">Enter Time(h:m:s,00:00:00): </p>
